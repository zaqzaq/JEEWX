...
<!-- 							    </script> -->
								<td class="value">
<!-- 							    <input id="content" name="content" value="${weixinArticle.content}" type="text" style="width: 300px" class="inputxt" > -->
									<textarea rows="7" cols="90" name="content" id="content"></textarea>
									<span class="Validform_checktip"></span>
