...
<div class="container-fluid"><a class="brand" href="http://erp.ljttehc.com" target="_blank">朗捷通 ERP &nbsp;&nbsp;<span class="slogan"></span></a>
...
<ul class="footer-links">
	<li style="display: inline;">&copy; 版权所有<a href="http://erp.ljttech.com" title="朗捷通">朗捷通</a></li>
	<li style="display: inline;">&nbsp;(推荐谷歌浏览器，获得更快响应速度) 技术支持: 朗捷通-信息中心></li>
</ul>
</div>
</footer>
