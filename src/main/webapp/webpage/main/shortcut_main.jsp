...
<div region="north" border="false" title="" style="BACKGROUND: #A8D7E9; height: 100px; padding: 1px; overflow: hidden;">
	...
	<tr>
		<td align="left" style="vertical-align: text-bottom"><!--
		        <img src="plug-in/weixin/logo/logo_weixin2.png"> <img src="plug-in/login/images/toplogo.png" width="550" height="52" alt="">-->
		</td>
...
<div align="center" style="color: #CC99FF; padding-top: 2px">&copy; 版权所有 <span class="tip"><a href="http://erp.ljttech.com" title="朗捷通">朗捷通</a> (推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度)  技术支持: 朗捷通-信息中心</span></div>
</div>
